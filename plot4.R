...
par(mfrow = c(2, 2)) 
plot(df$dt,df$Global_active_power, type="l", xlab="", ylab="Global Active Power", cex=0.2)
...
legend("topright", c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"), cex=0.35,lty=1, lwd=2.5, col=c("black", "red", "blue"))
